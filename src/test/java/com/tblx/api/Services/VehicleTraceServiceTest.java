...
@Tag("VehicleTraceServiceTest")
public class VehicleTraceServiceTest {
	...
	public void getVehicleTraceTest() throws BusgpsNotFoundException, BusgpsDateConversionException {
		...
		List<VehicleTrace> vehicleTraceArrayResult = this.vehicleTraceService.getVehicleTrace("2012-11-30T00:00:29", "2012-11-30T00:00:51", 40021	);
